...
def main():
    ...
    parser.add_argument('--lr_update', default=12, type=int,
                        help='Number of epochs to update the learning rate.')
    parser.add_argument('--workers', default=10, type=int,
                        help='Number of data loader workers.')
    parser.add_argument('--log_step', default=100, type=int,
                        help='Number of steps to print and record the log.')
    parser.add_argument('--val_step', default=2500, type=int,
...
def validate(opt, val_loader, model):
    ...
    # caption retrieval
    (r1, r5, r10, r20, r30, r_p, mAP, medr, meanr) = i2t(img_embs, cap_embs, cap_lens, sims)
    logging.info("Image to text: %.1f %.1f %.1f %.1f %.1f R_P: %.1f mAP: %.1f %.1f %.1f" %
                 (r1, r5, r10, r20, r30, r_p, mAP, medr, meanr))
    # image retrieval
    (r1i, r5i, r10i, r20i, r30i, r_pi, mAPi, medri, meanr) = t2i(
        img_embs, cap_embs, cap_lens, sims)
    logging.info("Text to image: %.1f %.1f %.1f %.1f %.1f R_P: %.1f mAP: %.1f %.1f %.1f" %
                 (r1i, r5i, r10i, r20i, r30i, r_pi, mAPi, medri, meanr))
